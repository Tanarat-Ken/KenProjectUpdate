...
- **เลขเอกสาร = เลขรันนิ่งเดียวต่อ 1 งาน** เก็บที่ `agentoffice_projects.doc_no` — เปลี่ยนเฉพาะ prefix ตามชนิดเอกสาร และมีปีที่ออกเอกสารจริง (ค.ศ.) ต่อท้าย prefix (เช่น งาน 009 ออกปี 2026 → `QT-2026-009` / `DN-2026-009` / `INV-2026-009` / `RC-2026-009`). เลขถัดไปของงานใหม่อยู่ที่ `agentoffice_settings.next_no` (แก้ได้ในหน้า “ตั้งค่า”)
