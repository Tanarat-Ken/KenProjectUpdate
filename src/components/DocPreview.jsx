  ...
  return (
    <div className="ao-doc" style={{ width: 520, background: '#fff', boxShadow: '0 4px 20px rgba(0,0,0,.1)', position: 'relative', borderRadius: 3 }}>
      ...
      <div style={{ padding: '32px 34px' }}>
        ...
        {/* Items table */}
        <div className="ao-doc-table" style={{ marginTop: 16, borderRadius: 6, overflow: 'hidden', border: `1px solid ${C.borderLight}` }}>
          <div className="ao-doc-thead" style={{ display: 'flex', background: C.ink, padding: '7px 11px' }}>
          ...
          {items.map((item, i) => (
            <div key={i} className="ao-doc-row" style={{ display: 'flex', alignItems: 'flex-start', padding: '8px 11px', borderBottom: i < items.length - 1 ? `1px solid ${C.borderLight}` : 'none', background: i % 2 ? C.panel : '#fff' }}>
        ...
        {/* Grand total */}
        <div className="ao-doc-total" style={{ display: 'flex', justifyContent: 'flex-end', marginTop: 12 }}>
