...
function DocumentsTab({ project, reload }) {
  ...
  return (
    <div className="ao-print-doctab" style={{ flex: 1, display: 'flex', minWidth: 0, background: C.bg }}>
      <div className="ao-print-hide" style={{ width: 268, borderRight: `1px solid ${C.border}`, padding: '20px 18px', flexShrink: 0 }}>
      ...
      <div className="ao-print-doccol" style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
        <div className="ao-print-hide" style={{ height: 52, borderBottom: `1px solid ${C.border}`, padding: '0 22px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: C.white, flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
...
export function ProjectDetail({ projectId, navigate }) {
  ...
  return (
    <div className="ao-print-root" style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
      <div className="ao-print-hide" style={{ borderBottom: `1px solid ${C.border}`, padding: '16px 28px 0', flexShrink: 0, background: C.white }}>
      ...
      <div className="ao-print-tabbody" style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
